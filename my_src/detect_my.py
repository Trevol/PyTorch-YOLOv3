...
class Options:
    ...
    outputDir = ""  # path to detection results
...
def getTinyYoloOptions():
    opt = Options()
    opt.image_folder = "../data/samples"
    opt.model_def = "../config/yolov3-tiny.cfg"
    opt.weights_path = "../weights/yolov3-tiny.weights"
    opt.class_path = "../data/coco.names"
    opt.conf_thres = 0.8
    opt.nms_thres = 0.4
    opt.batch_size = 1
    ...
    opt.img_size = 416
    opt.checkpoint_model = ""
    opt.outputDir = "./output/tiny-yolo"
    return opt


def getCustomYoloOptions():
    opt = Options()
    opt.image_folder = "../data/samples"
    opt.model_def = "../config/yolov3-320.cfg"
    opt.weights_path = "../weights/yolov3.weights"
    opt.class_path = "../data/coco.names"
    opt.conf_thres = 0.8
    opt.nms_thres = 0.4
